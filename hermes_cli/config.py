...
OPTIONAL_ENV_VARS = {
    ...
    "BROWSERLESS_HEADLESS": {
        "description": "Browserless headless mode: 'false' to launch a visible browser (default: true)",
        "prompt": "Headless mode (true/false)",
    ...
    "BROWSERLESS_PROXY": {
        "description": "Browserless built-in residential proxy type (optional, e.g. 'residential'). Requires paid plan.",
        "prompt": "Proxy type (e.g. residential)",
    ...
    "BROWSERLESS_PROXY_COUNTRY": {
        "description": "ISO 3166 country code for Browserless residential proxy geolocation (e.g. 'us', 'de')",
        "prompt": "Proxy country code (e.g. us)",
        "tools": ["browser_navigate"],
        "password": False,
        "category": "tool",
        "advanced": True,
    ...
    "BROWSERLESS_PROXY_STICKY": {
        "description": "Reuse the same residential proxy exit IP across the session ('true'/'false')",
        "prompt": "Sticky proxy IP (true/false)",
        "tools": ["browser_navigate"],
        "password": False,
        "category": "tool",
        "advanced": True,
    },
    "BROWSERLESS_EXTERNAL_PROXY": {
        "description": "Third-party proxy URL for Browserless sessions (e.g. socks5://user:pass@host:port)",
        "prompt": "External proxy URL",
        "tools": ["browser_navigate", "browser_click"],
        "password": True,
        "category": "tool",
        "advanced": True,
